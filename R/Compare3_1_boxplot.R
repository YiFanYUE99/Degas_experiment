...
G<-c("75_unstirred_1","75_unstirred_2","75_unstirred_3","75_unstirred_ZHU")
#1) MT P1
plot11<-ggplot(data = P1,aes(x=Group,y=RT))+
  ...
  xlim(G)+
  scale_y_continuous(limits = c(20,34.5),breaks = c(22,26,30,34))+
...
plot11
ggsave(plot = plot11,"pic/Compare3/Migration_P1.pdf",width = 105,height=70,units = "mm",dpi = 600)
